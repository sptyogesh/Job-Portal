        ...
        <div className='relative bg-gradient-to-r from-violet-50 to-purple-50 p-12 sm:p-24 lg:p-32 rounded-lg '>
            <div className=''>
                ...
                <div className='flex gap-4 '>
                    <a href='#'className='inline-block' ><img className='h-12 ' src={assets.play_store}></img></a>
                    <a href='#'className='inline-block' ><img className='h-12 ' src={assets.app_store}></img></a>
                </div>
            </div>
